# -*- coding: utf-8 -*-
"""Copy of sustainable smart city assistant using IBM granite LLM

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GFjDV2SHpCe_hrZeGMZZlcJhWDQ4SYnA
"""
...
def detect_anomaly(csv_file):
    ...
    if 'value' not in df.columns:
        return "⚠ CSV must contain a 'value' column."
    mean = df["value"].mean()
    std = df["value"].std()
